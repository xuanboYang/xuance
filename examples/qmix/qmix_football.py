...
from xuance.paddlepaddle.agents import QMIX_Agents


def parse_args():
    parser = argparse.ArgumentParser("Example: QMIX of XuanCe for Football environments.")
...
if __name__ == "__main__":
    parser = parse_args()
    configs_dict = get_configs(file_dir=f"qmix_football_configs/{parser.env_id}.yaml")
