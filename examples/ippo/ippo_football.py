...
from xuance.paddlepaddle.agents import IPPO_Agents


def parse_args():
    parser = argparse.ArgumentParser("Example: IPPO of XuanCe for Football environments.")
...
if __name__ == "__main__":
    parser = parse_args()
    configs_dict = get_configs(file_dir=f"ippo_football_configs/{parser.env_id}.yaml")
