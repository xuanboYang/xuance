...
from xuance.paddlepaddle.learners.multi_agent_rl.ippo_learner import IPPO_Learner
    ...
    def update(self, sample):
        ...
        if self.use_parameter_sharing:
            ...
            if self.use_global_state:
                ...
                joint_obs = paddle.concat(itemgetter(*self.agent_keys)(obs), axis=-1)
        ...
        for key in self.model_keys:
            ...
            loss_a.append(-paddle.min(paddle.stack([surrogate1, surrogate2]), axis=0).mean())
            ...
            if self.use_value_clip:
                value_clipped = values_i + (value_pred_i - values_i).clip(-self.value_clip_range,
                ...
                loss_c_ = paddle.maximum(loss_v, loss_v_clipped) * mask_values
    ...
    def update_rnn(self, sample):
        ...
        if self.use_parameter_sharing:
            ...
            if self.use_global_state:
                ...
                joint_obs = paddle.concat(itemgetter(*self.agent_keys)(obs), axis=-1).reshape((batch_size, seq_len, -1))
                critic_input = {k: joint_obs for k in self.agent_keys}
