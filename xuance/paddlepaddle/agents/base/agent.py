...
from xuance.paddlepaddle import REGISTRY_Representation, REGISTRY_Learners, Layer
from xuance.paddlepaddle.utils import nn, NormalizeFunctions, ActivationFunctions, init_distributed_mode
    ...
    def __init__(self,
        ...
        if self.distributed_training and self.world_size > 1:
            if self.rank == 0:
                ...
                time_string_tensor = paddle.to_tensor(list(time_string.encode('utf-8')), dtype='uint8').cuda(self.rank)
            else:
        ...
        self.policy: Optional[Layer] = None
        self.learner: Optional[Layer] = None
