...
class DCG_Agents(OffPolicyMARLAgents):
    ...
    def _build_learner(self, *args):
        from xuance.paddlepaddle.learners.multi_agent_rl.dcg_learner import DCG_Learner
    ...
    def _build_policy(self) -> Layer:
        ...
        # build policies
        from xuance.paddlepaddle.policies.coordination_graph import DCG_utility, DCG_payoff, Coordination_Graph
