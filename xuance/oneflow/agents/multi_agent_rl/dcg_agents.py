...
class DCG_Agents(OffPolicyMARLAgents):
    ...
    def _build_learner(self, *args):
        from xuance.oneflow.learners.multi_agent_rl.dcg_learner import DCG_Learner
    ...
    def _build_policy(self) -> Module:
        ...
        # build policies
        from xuance.oneflow.policies.coordination_graph import DCG_utility, DCG_payoff, Coordination_Graph
