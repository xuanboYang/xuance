...
from xuance.oneflow.policies import REGISTRY_Policy, VDN_mixer, QMIX_mixer
    ...
    def action(self,
        ...
        if not test_mode:
            ...
            if self.use_parameter_sharing:
                ...
                values_n = flow.stack(itemgetter(*self.agent_keys)(values_out), dim=-1).reshape(n_env, self.n_agents)
