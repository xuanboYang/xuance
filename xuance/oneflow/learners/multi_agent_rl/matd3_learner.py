...
class MATD3_Learner(LearnerMAS):
    ...
    def update_rnn(self, sample):
        ...
        if self.use_parameter_sharing:
            ...
            next_actions_joint = flow.concat(itemgetter(*self.agent_keys)(actions_next),
        ...
        if self.iterations % self.actor_update_delay == 0:
            ...
            for key in self.model_keys:
                ...
                if self.use_parameter_sharing:
                    ...
                    act_eval = flow.concat(itemgetter(*self.agent_keys)(a_joint), dim=-1).reshape(batch_size, seq_len,
                                                                                                   -1)
